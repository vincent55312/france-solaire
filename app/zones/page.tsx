            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-6 text-orange-600">
                <div className="flex items-center">
                  ...
                  <span className="font-semibold">4 départements</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {departments.map((dept) => (
              <Link 
                ...
                className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 p-6 border border-gray-200 hover:border-orange-300"
              >
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-100 to-yellow-100 rounded-full flex items-center justify-center mr-4">
                    <span className="text-orange-600 font-bold text-lg">{dept.code}</span>
                  </div>
                  <div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Panneaux Solaires</h3>
                <p className="text-gray-600 text-sm">Installation photovoltaïque pour réduire vos factures</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">Isolation thermique pour un confort optimal</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">Systèmes de chauffage performants et économiques</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Menuiseries</h3>
                <p className="text-gray-600 text-sm">Fenêtres et portes haute performance énergétique</p>
              </div>
            </div>
          </div>
        </div>
