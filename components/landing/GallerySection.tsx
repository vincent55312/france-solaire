    ...
    <section id="gallery" className="relative py-16 bg-gradient-to-br from-stone-50 to-gray-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="max-w-2xl mx-auto bg-white/60 backdrop-blur-sm rounded-xl p-4 md:p-5 border border-stone-100 shadow-sm">
            <p className="text-sm md:text-base text-gray-700 mb-3">
              <span className="font-semibold text-stone-600">Votre projet vous inspire ?</span> Concrétisons ensemble vos idées de rénovation énergétique !
            </p>
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center items-center">
              <a 
                href="#contact" 
                className="inline-flex items-center px-4 py-2 bg-stone-600 hover:bg-stone-700 text-white font-medium rounded-lg transition-colors duration-200 text-sm shadow-md hover:shadow-lg"
              >
        ...
        <div className="text-center mb-8">
          <Link 
            href="/galerie"
            className="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl text-sm"
          >
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
