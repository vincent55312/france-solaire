  ...
  return (
    <section id="prestations" className="relative py-10 md:py-16 bg-gradient-to-br from-stone-50 to-orange-50" role="region" aria-labelledby="prestations-title">
      <div className="container mx-auto px-4">
        <header className="text-center mb-10 md:mb-12 animation-delay-200">
          {/* Icône dédiée pour la section */}
          <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-orange-500 rounded-full shadow-lg mb-5 hover-lift">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-5">
          {prestations.map((prestation, index) => (
            <article key={index} className={`bg-white/80 backdrop-blur-sm rounded-xl p-3 md:p-4 lg:p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-amber-200/50 hover:border-amber-300/70 hover-lift`}>
        ...
        <div className="text-center mt-6 md:mt-8 animate-slideInUp animation-delay-1200">
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6 md:mb-8">
            <a 
              href="#contact" 
              className="inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold py-3 px-8 rounded-xl hover:from-amber-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl text-sm md:text-base hover-lift"
            ...
            <a 
              href="/services" 
              className="inline-flex items-center justify-center border-2 border-amber-500 text-amber-600 font-bold py-3 px-8 rounded-xl hover:bg-amber-500 hover:text-white transition-all duration-300 text-sm md:text-base hover-lift"
        ...
        <div className="text-center animate-slideInUp animation-delay-1400">
          <div className="bg-gradient-to-r from-amber-600 to-orange-500 rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 text-white shadow-2xl hover-lift">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 md:gap-4 mt-4 md:mt-6">
              ...
              <div className="text-center hover-lift">
                <div className="mb-1">
                  <FaHandHoldingUsd className="w-5 h-5 md:w-6 md:h-6 mx-auto animate-swing" />
                </div>
              ...
              <div className="text-center hover-lift">
                <div className="mb-1">
                  <svg className="w-5 h-5 md:w-6 md:h-6 mx-auto animate-softPulse" fill="currentColor" viewBox="0 0 24 24">
