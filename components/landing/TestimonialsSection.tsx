          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 h-full">
                    {/* Header avec profil et note */}
                    <div className="flex items-start mb-4">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center text-xs text-gray-500">
                            {testimonial.location === "Local Guide" && (
                              <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full mr-2 text-xs font-medium">
                                Local Guide
                              </span>
                            )}
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-xs text-gray-600 font-medium">{testimonial.rating}/5</span>
                    </div>
