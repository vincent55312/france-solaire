    ...
    <section id="hero" className="relative min-h-screen md:min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50 overflow-hidden" style={{ minHeight: 'calc(100vh)' }}>
      ...
      <div className="relative z-10 container mx-auto px-3 md:px-4 py-20 md:py-20" style={{ paddingTop: 'max(5rem, calc(80px + env(safe-area-inset-top)))', paddingBottom: 'max(5rem, env(safe-area-inset-bottom))' }}>
        <div className="text-center md:max-w-5xl mx-auto h-full flex flex-col justify-center">
          {/* Badges container */}
          <div className="flex flex-row items-center justify-center gap-2 md:gap-3 mb-8 md:mb-8 animate-slideInUp animation-delay-200">
            {/* Badge RGE */}
            <div className="inline-flex items-center px-3 py-2 md:px-4 md:py-2 bg-green-100 text-green-800 rounded-full text-xs md:text-sm font-medium border border-green-200 hover-lift">
            ...
            {/* Badge Google */}
            <div className="inline-flex items-center px-3 py-2 md:px-4 md:py-2 bg-white text-gray-800 rounded-full text-xs md:text-sm font-medium border-2 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group hover-lift">
              {/* Google Icon */}
              <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-[10px] md:text-xs text-blue-600 leading-none font-medium">Google</span>
              </div>
            </div>
          </div>

          {/* Main heading */}
          <h1 className="text-3xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 md:mb-4 leading-tight px-2 animate-slideInUp animation-delay-400">
            Votre Expert en{' '}
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-base md:text-lg lg:text-xl text-gray-600 mb-8 md:mb-10 max-w-none md:max-w-3xl mx-auto leading-relaxed px-2 animate-slideInUp animation-delay-600">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-row gap-2 md:gap-4 justify-center items-center mb-10 md:mb-12 px-2 animate-slideInUp animation-delay-800">
            <a 
              href="#contact" 
            ...
            <a 
              ...
              className="flex-1 md:w-auto inline-flex items-center justify-center px-4 py-4 md:px-6 md:py-3 bg-white text-green-600 font-bold rounded-xl border-2 border-green-600 hover:bg-green-50 transition-all duration-300 shadow-lg hover:shadow-xl text-sm md:text-base hover-lift"
            >
              <svg className="w-4 h-4 mr-2 animate-softPulse" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Trust indicators */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6 max-w-none md:max-w-3xl mx-auto px-2 animate-slideInUp animation-delay-1000">
            <div className="flex items-center justify-center space-x-3 p-4 md:p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 hover-lift">
              <div className="flex-shrink-0">
                <svg className="w-6 h-6 md:w-6 md:h-6 text-green-600 animate-subtleBounce" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-center space-x-3 p-4 md:p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 hover-lift">
              <div className="flex-shrink-0">
                <FaMoneyBillWave className="w-6 h-6 md:w-6 md:h-6 text-green-600 animate-swing" />
              </div>
              <div className="text-left">
